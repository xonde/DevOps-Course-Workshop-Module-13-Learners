...
See the [example code here](https://docs.microsoft.com/en-us/azure/azure-monitor/app/opencensus-python-request#tracking-flask-applications) for how to add the logger to `app.py`.
